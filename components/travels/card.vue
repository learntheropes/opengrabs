  ...
  <div class="card card-equal-height">
    ...
    <div class="card-image">
      <figure style="background-color: grey" class="image">
        <img :src="getImage" :alt="'Image of ' + travel.destination_city" :title="'Image of ' + travel.destination_city" loading="lazy" />
      </figure>
    </div>
...
export default {
  ...
  computed: {
    ...
    getImage() {
      return this.travel.destination_photo.replace('https://lh3.googleusercontent.com/places/', '/img/places/tr:h-210/')
    }
  },
  methods: {
    login() {
